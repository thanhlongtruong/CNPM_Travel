    ...
    <div className="absolute z-10 flex h-full w-full items-center bg-white/10 backdrop-brightness-75">
      <div className="m-auto h-[490px] w-[450px] rounded-lg bg-white px-4">
        ...
        <div className="my-2 mb-5">
          <p className="p-0 text-base font-medium text-slate-500">Email/ Số điện thoại di động</p>
          <input
        ...
        <div className="w-full rounded-md bg-slate-200 p-2 text-center font-bold text-slate-400">Tiếp tục</div>
        <p className="my-5 text-center text-sm font-semibold text-slate-600">hoặc đăng nhập / đăng kí với</p>
        ...
        <p className="mt-6 text-center">
          Bằng cách đăng ký, bạn đồng ý với <span className="font-semibold text-cyan-400">Điều khoản & Điều kiện</span>{' '}
          của chúng tôi và bạn đã đọc
          <span className="font-semibold text-cyan-400"> Chính Sách Quyền Riêng Tư</span> của chúng tôi.
        </p>
      </div>
    </div>
  );
