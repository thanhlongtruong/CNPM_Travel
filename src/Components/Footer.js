function Footer() {
  return (
    <div className="w-screen">
      <div className="pt-[55px] pb-[55px] flex bg-[rgba(28,41,48,1.00)] w-full px-5">
        <div className=" flex w-full justify-center items-center gap-x-16 ">
          <div className="ml-20 mt-[-20px] flex flex-col justify-center items-start">
            <img
            ...
            <div className="grid grid-cols-3 justify-between mr-[20px] mb-[10px] gap-y-[15px]">
              <img
            ...
            <div className="flex">
              <div className="bg-gray-700 w-[250px] h-[60px] rounded-xl">
                <div className="p-4 ml-8 text-white font-bold">
            ...
            <div className="mt-[16px]">
              ...
              <div className="grid grid-cols-4 justify-between mt-[10px]">
                <div className="flex mr-[8px] mb-[8px]">
                  <img
          ...
          <div className="w-[67%] gap-x-14 flex">
            <div className="w-[22.3%]">
              ...
              <ul className="mb-[32px]">
                <li className="mb-[8px] font-medium">
                  <a
                    className=" text-sm text-gray-400 hover:underline hover:decoration-white hover:text-white"
                    href="#"
                  >
                    Cách đặt chỗ
                  </a>
              ...
              <div>
                ...
                <ul className="mt-2 ">
                  <li className="font-bold mb-3">
                    <a
                      className=" flex text-sm text-gray-400 hover:underline hover:decoration-white hover:text-white"
                      href="#"
                    >
                      <img
                        className="mr-2"
            ...
            <div className="w-[22.3%]">
              <div>
                <h3 className="font-bold text-white mb-[8px]">Sản phẩm</h3>
              </div>
              <ul className="mb-[32px]">
                <li className="mb-[8px] font-medium">
                  <a
            ...
            <div className="w-[22.3%]">
              <div>
                <h3 className="text-white font-bold mb-[8px]">Khác</h3>
              </div>
              <ul className="mb-[32px]">
                <li className="mb-[8px] font-medium">
                  <a
